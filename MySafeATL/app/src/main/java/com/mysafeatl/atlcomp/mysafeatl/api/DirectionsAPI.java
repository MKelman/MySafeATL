...
import com.mysafeatl.atlcomp.mysafeatl.models.Distance;
import com.mysafeatl.atlcomp.mysafeatl.models.Duration;
...
public class DirectionsAPI {
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        return DIRECTION_API_URL + "origin=" + urlOrigin + "&destination=" + urlDestination
                + "&alternatives=true" + "&mode=walking" + "&key=" + SERVER_KEY;
    }
